...
public class RouteBean {
    ...
    private int distance, travelDuration;
    // Getters Setters
    ...
    public int getTravelDuration() { return travelDuration; } public void setTravelDuration(int travelDuration) { this.travelDuration = travelDuration; }
}